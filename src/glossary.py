...
LESSON_21 = (
    ...
    + c.compare_table(
        ...
        [
            ...
            [L("<code>Node</code>", "<code>Node</code>"), _term("切块后带元数据/关系的检索单位", "a chunked, metadata- and relationship-bearing unit of retrieval"), L('<a href="04-documents-nodes.html">04</a>', '<a href="04-documents-nodes.html">04</a>')],
            ...
            [L("Vector Store", "Vector Store"), _term("存向量+元数据并做近邻查询", "stores vectors+metadata, does nearest-neighbor search"), L('<a href="09-vector-stores.html">09</a>', '<a href="09-vector-stores.html">09</a>')],
            ...
            [L("进阶检索 Advanced Retrieval", "Advanced Retrieval"), _term("融合 / 自动合并 / 递归 / 路由等进阶检索器", "fusion / auto-merging / recursive / router retrievers"), L('<a href="18-advanced-retrieval.html">18</a>', '<a href="18-advanced-retrieval.html">18</a>')],
